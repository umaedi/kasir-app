  ...
  <div class="modal fade" id="modalAksi" tabindex="-1" aria-labelledby="modalAksiLabel" aria-hidden="true">
   ...
   <script type="text/javascript">
    ...
    function initDatabase() {
        const request = indexedDB.open("POSDatabase", 2); // Increased version
    ...
    async function syncToServer() {
        ...
        try {
            ...
            const param = {
                url: '/api/transactions/batch', // Correct endpoint
                method: 'POST',
                data: JSON.stringify({
            ...
            if (result && result.success) {
                // Mark all successfully synced transactions
                ...
                // Show success message if there were any transactions synced
    ...
    function startSyncInterval() {
        // Wait a bit before first sync to ensure everything is ready
        setTimeout(() => {
            syncToServer();
        }, 3000);
    ...
    // Calculator functions (tetap sama)
